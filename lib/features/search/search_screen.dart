...
import 'package:news_app/features/search/controllers/search_controllers.dart';
...
class SearchScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => SearchScreenControllers(
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Consumer<SearchScreenControllers>(
            builder: (context, SearchScreenControllers controller, child) {
              return Column(
                children: [
